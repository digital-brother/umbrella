...
def test_document_library(client, contract):
    ...
    # contracting party and child contract should be auto-generated by ContractFactory itself
    # That is implemented already in for ContractFactory and group assignment
    # TODO: Generate contracting party and child contract during contract factory generation
...
def test_contracts_statistics(client):
    ...
    # TODO: should be provided as fixtures here
    ContractFactory()
    TaskFactory()
...
def test_tag_list(client, contract):
    ...
    # TODO: Generate tag during contract factory generation
    tag = TagFactory()
...
def test_create_tag_with_others_type(client, contract):
    url = reverse('tag-list')
    # 1 Test shoud test 1 thing.
    # TODO: Just delete case for invalid data
    valid_data = {
        "name": "Test",
        "type": "others",
        "contracts": [
...
def test_update_tag_with_others_type(client, contract):
    ...
    # Url should be calculated within reverse
    # TODO: use ./manage.py show_urls to see urls and their names
